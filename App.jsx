...
import { Plus, X, TrendingUp, Users, Swords, Settings as SettingsIcon, Trash2, AlertCircle, ChevronDown, Pencil, Search, Download, Layers } from "lucide-react";
    ...
    <div style={{ paddingBottom: 90 }}>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        <p style={{ fontSize: 12, color: "#5F655C", margin: "0 0 14px", lineHeight: 1.6 }}>
          {bets.length} bets stored on this device. Everything in this app is built entirely from the bets and scores you enter yourself. Nothing is fetched from outside.
        </p>
